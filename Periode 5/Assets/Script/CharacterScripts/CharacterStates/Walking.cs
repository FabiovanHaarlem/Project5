...
public class Walking : ICharacterStates
{
    ...
    public void UpdateState()
    {
        ...
        m_CharacterController.gameObject.transform.position += new Vector3(-InputManager.Instance.GetAxis(m_Inputs[4]) * m_HorMoveSpeed * Time.deltaTime, 0, -InputManager.Instance.GetAxis(m_Inputs[5]) * m_VerMoveSpeed * Time.deltaTime);
        ...
        if (other.CompareTag("Player"))
            {
                ...
                m_CharacterController.PlayAttackSound();
            }
        }
    }
